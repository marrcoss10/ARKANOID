...
public abstract class Config<COUNT_BLOCKS_X> {

	public static final int SCREEN_WIDTH = 800;
	public static final int SCREEN_HEIGHT = 600;

	public static final double BALL_RADIUS = 10.0;
	public static double BALL_VELOCITY;

	public static void velocidadBola(int pNivel){
		if (pNivel == 1){
			BALL_VELOCITY = 0.17;
		}else if(pNivel == 2){
			BALL_VELOCITY = 0.22;
	...
	public static int BLOCKS_X;
	public static int BLOCKS_Y;

	public static void numeroLadrillos(int pNivel){
		if (pNivel == 1){
			BLOCKS_X = 10;
			BLOCKS_Y = 3;
		}else if(pNivel == 2){
	...
	public static Color ladSuerte = Color.CYAN;
	...
	public static Color BRICK_ESP_COLOR = ladSuerte;
}